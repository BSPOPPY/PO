...
while True:
    ...
    screen.fill((0, 0, 0))
    pygame.draw.rect(screen, (255, 69, 0), player1)
    pygame.draw.rect(screen, (120, 150, 110), player2)
    pygame.draw.ellipse(screen, (220, 0, 0), ball)
    pygame.draw.aaline(screen, (100, 150, 255), (width / 2, 0), (width / 2, height))

   
    player1_text = font.render("ОЧКИ:" + str(player1_score), False, (255, 255, 255))
    screen.blit(player1_text, [600, 50])
    player2_text = font.render("ОЧКО:" + str(player2_score), False, (255, 255, 255))
